      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-16">
        ...
        >
          <motion.div
            ...
            className="inline-block mb-6 px-6 py-3 bg-gradient-to-r from-yellow-400/20 to-yellow-600/20 rounded-full border border-yellow-400/30 backdrop-blur-sm relative z-30 shadow-lg"
          >
            <span className="text-yellow-400 font-semibold text-sm sm:text-base">🚀 AI & Tech Learning Experience</span>
          </motion.div>
          ...
          <motion.p
            ...
            className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed"
          >
            At{' '}
        ...
        <motion.div
          ...
          className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-5xl mx-auto relative z-20"
        >
          {[
            { 
              icon: Brain, 
        ...
        <motion.div
          ...
          className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto relative z-20"
        >
          {[
